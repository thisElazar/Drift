// TerrAIGameInstance.cpp - Game Settings & Map Management Implementation
...
UTerrAIGameInstance::UTerrAIGameInstance()
{
    ...
    UE_LOG(LogTemp, Log, TEXT("TerrAIGameInstance: SIMPLIFIED MODE - Fixed 513x513 grid, scaling via TerrainScale"));
...
void UTerrAIGameInstance::InitializeDefaultMaps()
{
    ...
    {
        UE_LOG(LogTemp, Log, TEXT("TerrAIGameInstance: Using %d pre-configured maps"),
               AvailableMaps.Num());
        return;
    }
...
void UTerrAIGameInstance::SelectMap(int32 MapIndex)
{
    ...
    {
        UE_LOG(LogTemp, Error, TEXT("TerrAIGameInstance: Invalid map index %d (max %d)"),
...
void UTerrAIGameInstance::StartNewWorldWithSelectedMap()
{
    StartNewWorldWithMap(SelectedMapIndex);
}

FTerrainMapDefinition UTerrAIGameInstance::GenerateRandomMapDefinition()
{
...
FTerrainMapDefinition UTerrAIGameInstance::GetMapDefinitionByIndex(int32 Index) const
{
...
FTerrainMapDefinition UTerrAIGameInstance::CreateDefaultProceduralDefinition()
{
...
void UTerrAIGameInstance::SetPreviewSettings(EDefaultTexture InTexture, bool bInWeather)
{
