/**
 * ============================================
 * DRIFT ATMOSPHERE CONTROLLER - REORGANIZED
 * ============================================
 ...
 * - Drift Systems: AtmosphericSystem, DynamicTerrain, WaterSystem
 ...
 * - UpdateVolumetricCloudComponent: Sync Drift â†’ UE5 clouds
 ...
 * - Allows temporary Drift control without permanent changes
 *
 ...
 *
 * HYBRID ARCHITECTURE:
 * Drift provides physics-accurate atmospheric simulation, while UE5
 ...
 * 3. DirectionalLight: Sun lighting (shared with Drift)
 * 4. SkyLight: Ambient illumination
 *
 * INTEGRATION MODES:
 * - bEnableHybridIntegration: Master toggle for UE5 sync
 * - Can run Drift physics with UE5 rendering
