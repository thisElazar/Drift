...
#define LOW_PRECISION`),t}function QE(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Wf?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===wg?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===oi&&(t="SHADOWMAP_TYPE_VSM"),t}function ZE(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case rs:case ss:t="ENVMAP_TYPE_CUBE";break;case Ga:t="ENVMAP_TYPE_CUBE_UV";break}return t}function JE(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case ss:t="ENVMAP_MODE_REFRACTION";break}return t}function tx(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case qf:t="ENVMAP_BLENDING_MULTIPLY";break;case Kg:t="ENVMAP_BLENDING_MIX";break;case Qg:t="ENVMAP_BLENDING_ADD";break}return t}function ex(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function nx(i,t,e,n){const r=i.getContext(),s=e.defines;let o=e.vertexShader,a=e.fragmentShader;const c=QE(e),h=ZE(e),u=JE(e),d=tx(e),f=ex(e),p=e.isWebGL2?"":zE(e),y=GE(e),E=WE(s),_=r.createProgram();let m,C,b=e.glslVersion?"#version "+e.glslVersion+`
...
`].filter(Jr).join(`
`)),o=pl(o),o=gd(o,e),o=_d(o,e),a=pl(a),a=gd(a,e),a=_d(a,e),o=vd(o),a=vd(a),e.isWebGL2&&e.isRawShaderMaterial!==!0&&(b=`#version 300 es
...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
      ...
      `,side:vn}),n=new Ie(t,e);this.scene.add(n)}setupLighting(){const t=new Nx(8900331,8413248,.8);this.scene.add(t),this.sun=new Ad(16774373,1.6),this.sun.position.set(this.terrainWidth*.4,zn*4,this.terrainHeight*.2),this.scene.add(this.sun);const e=new Ra(this.terrainWidth*.06,32),n=new wn({color:16772676,fog:!1});this.sunDisc=new Ie(e,n),this.sunDisc.position.copy(this.sun.position),this.scene.add(this.sunDisc);const r=new Ra(this.terrainWidth*.1,32),s=new fi({uniforms:{color:{value:new oe(16768341)},opacity:{value:.4}},vertexShader:`
        varying vec2 vUv;
        void main() {
          vUv = uv;
          gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wS{constructor(){this.reject=()=>{},this.resolve=()=>{},this.promise=new Promise((t,e)=>{this.resolve=t,this.reject=e})}wrapCallback(t){return(e,n)=>{e?this.reject(e):this.resolve(n),typeof t=="function"&&(this.promise.catch(()=>{}),t.length===1?t(e):t(e,n))}}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pi=new Up("@firebase/app"),iT="@firebase/app-compat",rT="@firebase/analytics-compat",sT="@firebase/analytics",oT="@firebase/app-check-compat",aT="@firebase/app-check",cT="@firebase/auth",lT="@firebase/auth-compat",hT="@firebase/database",uT="@firebase/data-connect",dT="@firebase/database-compat",fT="@firebase/functions",pT="@firebase/functions-compat",mT="@firebase/installations",gT="@firebase/installations-compat",_T="@firebase/messaging",vT="@firebase/messaging-compat",yT="@firebase/performance",ET="@firebase/performance-compat",xT="@firebase/remote-config",ST="@firebase/remote-config-compat",TT="@firebase/storage",MT="@firebase/storage-compat",bT="@firebase/firestore",wT="@firebase/vertexai-preview",AT="@firebase/firestore-compat",RT="firebase",CT="10.14.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ub{constructor(t){this.ct=t}}function db(i){const t=sb({parent:i.parent,structuredQuery:i.structuredQuery});return i.limitType==="LAST"?Ua(t,t.limit,"L"):t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mb{constructor(){this.changes=new Ts(t=>t.toString(),(t,e)=>t.isEqual(e)),this.changesApplied=!1}addEntry(t){this.assertNotApplied(),this.changes.set(t.key,t)}removeEntry(t,e){this.assertNotApplied(),this.changes.set(t,un.newInvalidDocument(t).setReadTime(e))}getEntry(t,e){this.assertNotApplied();const n=this.changes.get(e);return n!==void 0?ot.resolve(n):this.getFromCache(t,e)}getEntries(t,e){return this.getAllFromCache(t,e)}apply(t){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(t)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gb{constructor(t,e){this.overlayedDocument=t,this.mutatedFields=e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Eb{constructor(){this.sessionToken=en.EMPTY_BYTE_STRING}getSessionToken(t){return ot.resolve(this.sessionToken)}setSessionToken(t,e){return this.sessionToken=e,ot.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ah{constructor(){this.Tr=new tn(qe.Er),this.dr=new tn(qe.Ar)}isEmpty(){return this.Tr.isEmpty()}addReference(t,e){const n=new qe(t,e);this.Tr=this.Tr.add(n),this.dr=this.dr.add(n)}Rr(t,e){t.forEach(n=>this.addReference(n,e))}removeReference(t,e){this.Vr(new qe(t,e))}mr(t,e){t.forEach(n=>this.removeReference(n,e))}gr(t){const e=new Bt(new we([])),n=new qe(e,t),r=new qe(e,t+1),s=[];return this.dr.forEachInRange([n,r],o=>{this.Vr(o),s.push(o.key)}),s}pr(){this.Tr.forEach(t=>this.Vr(t))}Vr(t){this.Tr=this.Tr.delete(t),this.dr=this.dr.delete(t)}yr(t){const e=new Bt(new we([])),n=new qe(e,t),r=new qe(e,t+1);let s=ce();return this.dr.forEachInRange([n,r],o=>{s=s.add(o.key)}),s}containsKey(t){const e=new qe(t,0),n=this.Tr.firstAfterOrEqual(e);return n!==null&&t.isEqual(n.key)}}class qe{constructor(t,e){this.key=t,this.wr=e}static Er(t,e){return Bt.comparator(t.key,e.key)||fe(t.wr,e.wr)}static Ar(t,e){return fe(t.wr,e.wr)||Bt.comparator(t.key,e.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sb{constructor(t){this.Mr=t,this.docs=function(){return new Pe(Bt.comparator)}(),this.size=0}setIndexManager(t){this.indexManager=t}addEntry(t,e){const n=e.key,r=this.docs.get(n),s=r?r.size:0,o=this.Mr(e);return this.docs=this.docs.insert(n,{document:e.mutableCopy(),size:o}),this.size+=o-s,this.indexManager.addToCollectionParentIndex(t,n.path.popLast())}removeEntry(t){const e=this.docs.get(t);e&&(this.docs=this.docs.remove(t),this.size-=e.size)}getEntry(t,e){const n=this.docs.get(e);return ot.resolve(n?n.document.mutableCopy():un.newInvalidDocument(e))}getEntries(t,e){let n=gi();return e.forEach(r=>{const s=this.docs.get(r);n=n.insert(r,s?s.document.mutableCopy():un.newInvalidDocument(r))}),ot.resolve(n)}getDocumentsMatchingQuery(t,e,n,r){let s=gi();const o=e.path,a=new Bt(o.child("")),c=this.docs.getIteratorFrom(a);for(;c.hasNext();){const{key:h,value:{document:u}}=c.getNext();if(!o.isPrefixOf(h.path))break;h.path.length>o.length+1||sM(rM(u),n)<=0||(r.has(u.key)||Qa(e,u))&&(s=s.insert(u.key,u.mutableCopy()))}return ot.resolve(s)}getAllFromCollectionGroup(t,e,n,r){$t()}Or(t,e){return ot.forEach(this.docs,n=>e(n))}newChangeBuffer(t){return new Tb(this)}getSize(t){return ot.resolve(this.size)}}class Tb extends mb{constructor(t){super(),this.cr=t}applyChanges(t){const e=[];return this.changes.forEach((n,r)=>{r.isValidDocument()?e.push(this.cr.addEntry(t,r)):this.cr.removeEntry(n)}),ot.waitFor(e)}getFromCache(t,e){return this.cr.getEntry(t,e)}getAllFromCache(t,e){return this.cr.getEntries(t,e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bb{constructor(t,e){this.qr={},this.overlays={},this.Qr=new Ql(0),this.Kr=!1,this.Kr=!0,this.$r=new Eb,this.referenceDelegate=t(this),this.Ur=new Mb(this),this.indexManager=new fb,this.remoteDocumentCache=function(r){return new Sb(r)}(n=>this.referenceDelegate.Wr(n)),this.serializer=new ub(e),this.Gr=new vb(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.Kr=!1,Promise.resolve()}get started(){return this.Kr}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(t){return this.indexManager}getDocumentOverlayCache(t){let e=this.overlays[t.toKey()];return e||(e=new yb,this.overlays[t.toKey()]=e),e}getMutationQueue(t,e){let n=this.qr[t.toKey()];return n||(n=new xb(e,this.referenceDelegate),this.qr[t.toKey()]=n),n}getGlobalsCache(){return this.$r}getTargetCache(){return this.Ur}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Gr}runTransaction(t,e,n){At("MemoryPersistence","Starting transaction:",t);const r=new wb(this.Qr.next());return this.referenceDelegate.zr(),n(r).next(s=>this.referenceDelegate.jr(r).next(()=>s)).toPromise().then(s=>(r.raiseOnCommittedEvent(),s))}Hr(t,e){return ot.or(Object.values(this.qr).map(n=>()=>n.containsKey(t,e)))}}class wb extends aM{constructor(t){super(),this.currentSequenceNumber=t}}class ch{constructor(t){this.persistence=t,this.Jr=new ah,this.Yr=null}static Zr(t){return new ch(t)}get Xr(){if(this.Yr)return this.Yr;throw $t()}addReference(t,e,n){return this.Jr.addReference(n,e),this.Xr.delete(n.toString()),ot.resolve()}removeReference(t,e,n){return this.Jr.removeReference(n,e),this.Xr.add(n.toString()),ot.resolve()}markPotentiallyOrphaned(t,e){return this.Xr.add(e.toString()),ot.resolve()}removeTarget(t,e){this.Jr.gr(e.targetId).forEach(r=>this.Xr.add(r.toString()));const n=this.persistence.getTargetCache();return n.getMatchingKeysForTargetId(t,e.targetId).next(r=>{r.forEach(s=>this.Xr.add(s.toString()))}).next(()=>n.removeTargetData(t,e))}zr(){this.Yr=new Set}jr(t){const e=this.persistence.getRemoteDocumentCache().newChangeBuffer();return ot.forEach(this.Xr,n=>{const r=Bt.fromPath(n);return this.ei(t,r).next(s=>{s||e.removeEntry(r,Zt.min())})}).next(()=>(this.Yr=null,e.apply(t)))}updateLimboDocument(t,e){return this.ei(t,e).next(n=>{n?this.Xr.delete(e.toString()):this.Xr.add(e.toString())})}Wr(t){return 0}ei(t,e){return ot.or([()=>ot.resolve(this.Jr.containsKey(e)),()=>this.persistence.getTargetCache().containsKey(t,e),()=>this.persistence.Hr(t,e)])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dm{constructor(t,e,n,r,s,o,a,c){this.ui=t,this.Ho=n,this.Jo=r,this.connection=s,this.authCredentialsProvider=o,this.appCheckCredentialsProvider=a,this.listener=c,this.state=0,this.Yo=0,this.Zo=null,this.Xo=null,this.stream=null,this.e_=0,this.t_=new Pm(t,e)}n_(){return this.state===1||this.state===5||this.r_()}r_(){return this.state===2||this.state===3}start(){this.e_=0,this.state!==4?this.auth():this.i_()}async stop(){this.n_()&&await this.close(0)}s_(){this.state=0,this.t_.reset()}o_(){this.r_()&&this.Zo===null&&(this.Zo=this.ui.enqueueAfterDelay(this.Ho,6e4,()=>this.__()))}a_(t){this.u_(),this.stream.send(t)}async __(){if(this.r_())return this.close(0)}u_(){this.Zo&&(this.Zo.cancel(),this.Zo=null)}c_(){this.Xo&&(this.Xo.cancel(),this.Xo=null)}async close(t,e){this.u_(),this.c_(),this.t_.cancel(),this.Yo++,t!==4?this.t_.reset():e&&e.code===nt.RESOURCE_EXHAUSTED?(mi(e.toString()),mi("Using maximum backoff delay to prevent overloading the backend."),this.t_.Wo()):e&&e.code===nt.UNAUTHENTICATED&&this.state!==3&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),this.stream!==null&&(this.l_(),this.stream.close(),this.stream=null),this.state=t,await this.listener.mo(e)}l_(){}auth(){this.state=1;const t=this.h_(this.Yo),e=this.Yo;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then(([n,r])=>{this.Yo===e&&this.P_(n,r)},n=>{t(()=>{const r=new Tt(nt.UNKNOWN,"Fetching auth token failed: "+n.message);return this.I_(r)})})}P_(t,e){const n=this.h_(this.Yo);this.stream=this.T_(t,e),this.stream.Eo(()=>{n(()=>this.listener.Eo())}),this.stream.Ro(()=>{n(()=>(this.state=2,this.Xo=this.ui.enqueueAfterDelay(this.Jo,1e4,()=>(this.r_()&&(this.state=3),Promise.resolve())),this.listener.Ro()))}),this.stream.mo(r=>{n(()=>this.I_(r))}),this.stream.onMessage(r=>{n(()=>++this.e_==1?this.E_(r):this.onNext(r))})}i_(){this.state=5,this.t_.Go(async()=>{this.state=0,this.start()})}I_(t){return At("PersistentStream",`close with error: ${t}`),this.stream=null,this.close(4,t)}h_(t){return e=>{this.ui.enqueueAndForget(()=>this.Yo===t?e():(At("PersistentStream","stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve()))}}}class zb extends Dm{constructor(t,e,n,r,s,o){super(t,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",e,n,r,o),this.serializer=s}T_(t,e){return this.connection.Bo("Listen",t,e)}E_(t){return this.onNext(t)}onNext(t){this.t_.reset();const e=tb(this.serializer,t),n=function(s){if(!("targetChange"in s))return Zt.min();const o=s.targetChange;return o.targetIds&&o.targetIds.length?Zt.min():o.readTime?Qn(o.readTime):Zt.min()}(t);return this.listener.d_(e,n)}A_(t){const e={};e.database=Pl(this.serializer),e.addTarget=function(s,o){let a;const c=o.target;if(a=wl(c)?{documents:ib(s,c)}:{query:rb(s,c)._t},a.targetId=o.targetId,o.resumeToken.approximateByteSize()>0){a.resumeToken=Sm(s,o.resumeToken);const h=Rl(s,o.expectedCount);h!==null&&(a.expectedCount=h)}else if(o.snapshotVersion.compareTo(Zt.min())>0){a.readTime=Va(s,o.snapshotVersion.toTimestamp());const h=Rl(s,o.expectedCount);h!==null&&(a.expectedCount=h)}return a}(this.serializer,t);const n=ob(this.serializer,t);n&&(e.labels=n),this.a_(e)}R_(t){const e={};e.database=Pl(this.serializer),e.removeTarget=t,this.a_(e)}}class Gb extends Dm{constructor(t,e,n,r,s,o){super(t,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",e,n,r,o),this.serializer=s}get V_(){return this.e_>0}start(){this.lastStreamToken=void 0,super.start()}l_(){this.V_&&this.m_([])}T_(t,e){return this.connection.Bo("Write",t,e)}E_(t){return ge(!!t.streamToken),this.lastStreamToken=t.streamToken,ge(!t.writeResults||t.writeResults.length===0),this.listener.f_()}onNext(t){ge(!!t.streamToken),this.lastStreamToken=t.streamToken,this.t_.reset();const e=nb(t.writeResults,t.commitTime),n=Qn(t.commitTime);return this.listener.g_(n,e)}p_(){const t={};t.database=Pl(this.serializer),this.a_(t)}m_(t){const e={streamToken:this.lastStreamToken,writes:t.map(n=>eb(this.serializer,n))};this.a_(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rw{constructor(){this.z_=void 0,this.j_=[]}H_(){return this.j_.some(t=>t.J_())}}class sw{constructor(){this.queries=Af(),this.onlineState="Unknown",this.Y_=new Set}terminate(){(function(e,n){const r=Jt(e),s=r.queries;r.queries=Af(),s.forEach((o,a)=>{for(const c of a.j_)c.onError(n)})})(this,new Tt(nt.ABORTED,"Firestore shutting down"))}}function Af(){return new Ts(i=>om(i),Ka)}async function ow(i,t){const e=Jt(i);let n=3;const r=t.query;let s=e.queries.get(r);s?!s.H_()&&t.J_()&&(n=2):(s=new rw,n=t.J_()?0:1);try{switch(n){case 0:s.z_=await e.onListen(r,!0);break;case 1:s.z_=await e.onListen(r,!1);break;case 2:await e.onFirstRemoteStoreListen(r)}}catch(o){const a=mh(o,`Initialization of query '${Yr(t.query)}' failed`);return void t.onError(a)}e.queries.set(r,s),s.j_.push(t),t.Z_(e.onlineState),s.z_&&t.X_(s.z_)&&gh(e)}async function aw(i,t){const e=Jt(i),n=t.query;let r=3;const s=e.queries.get(n);if(s){const o=s.j_.indexOf(t);o>=0&&(s.j_.splice(o,1),s.j_.length===0?r=t.J_()?0:1:!s.H_()&&t.J_()&&(r=2))}switch(r){case 0:return e.queries.delete(n),e.onUnlisten(n,!0);case 1:return e.queries.delete(n),e.onUnlisten(n,!1);case 2:return e.onLastRemoteStoreUnlisten(n);default:return}}function cw(i,t){const e=Jt(i);let n=!1;for(const r of t){const s=r.query,o=e.queries.get(s);if(o){for(const a of o.j_)a.X_(r)&&(n=!0);o.z_=r}}n&&gh(e)}function lw(i,t,e){const n=Jt(i),r=n.queries.get(t);if(r)for(const s of r.j_)s.onError(e);n.queries.delete(t)}function gh(i){i.Y_.forEach(t=>{t.next()})}var Ll,Rf;(Rf=Ll||(Ll={})).ea="default",Rf.Cache="cache";class hw{constructor(t,e,n){this.query=t,this.ta=e,this.na=!1,this.ra=null,this.onlineState="Unknown",this.options=n||{}}X_(t){if(!this.options.includeMetadataChanges){const n=[];for(const r of t.docChanges)r.type!==3&&n.push(r);t=new ps(t.query,t.docs,t.oldDocs,n,t.mutatedKeys,t.fromCache,t.syncStateChanged,!0,t.hasCachedResults)}let e=!1;return this.na?this.ia(t)&&(this.ta.next(t),e=!0):this.sa(t,this.onlineState)&&(this.oa(t),e=!0),this.ra=t,e}onError(t){this.ta.error(t)}Z_(t){this.onlineState=t;let e=!1;return this.ra&&!this.na&&this.sa(this.ra,t)&&(this.oa(this.ra),e=!0),e}sa(t,e){if(!t.fromCache||!this.J_())return!0;const n=e!=="Offline";return(!this.options._a||!n)&&(!t.docs.isEmpty()||t.hasCachedResults||e==="Offline")}ia(t){if(t.docChanges.length>0)return!0;const e=this.ra&&this.ra.hasPendingWrites!==t.hasPendingWrites;return!(!t.syncStateChanged&&!e)&&this.options.includeMetadataChanges===!0}oa(t){t=ps.fromInitialDocuments(t.query,t.docs,t.mutatedKeys,t.fromCache,t.hasCachedResults),this.na=!0,this.ta.next(t)}J_(){return this.options.source!==Ll.Cache}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bm{constructor(t){this.key=t}}class km{constructor(t){this.key=t}}class uw{constructor(t,e){this.query=t,this.Ta=e,this.Ea=null,this.hasCachedResults=!1,this.current=!1,this.da=ce(),this.mutatedKeys=ce(),this.Aa=am(t),this.Ra=new is(this.Aa)}get Va(){return this.Ta}ma(t,e){const n=e?e.fa:new wf,r=e?e.Ra:this.Ra;let s=e?e.mutatedKeys:this.mutatedKeys,o=r,a=!1;const c=this.query.limitType==="F"&&r.size===this.query.limit?r.last():null,h=this.query.limitType==="L"&&r.size===this.query.limit?r.first():null;if(t.inorderTraversal((u,d)=>{const f=r.get(u),p=Qa(this.query,d)?d:null,y=!!f&&this.mutatedKeys.has(f.key),E=!!p&&(p.hasLocalMutations||this.mutatedKeys.has(p.key)&&p.hasCommittedMutations);let _=!1;f&&p?f.data.isEqual(p.data)?y!==E&&(n.track({type:3,doc:p}),_=!0):this.ga(f,p)||(n.track({type:2,doc:p}),_=!0,(c&&this.Aa(p,c)>0||h&&this.Aa(p,h)<0)&&(a=!0)):!f&&p?(n.track({type:0,doc:p}),_=!0):f&&!p&&(n.track({type:1,doc:f}),_=!0,(c||h)&&(a=!0)),_&&(p?(o=o.add(p),s=E?s.add(u):s.delete(u)):(o=o.delete(u),s=s.delete(u)))}),this.query.limit!==null)for(;o.size>this.query.limit;){const u=this.query.limitType==="F"?o.last():o.first();o=o.delete(u.key),s=s.delete(u.key),n.track({type:1,doc:u})}return{Ra:o,fa:n,ns:a,mutatedKeys:s}}ga(t,e){return t.hasLocalMutations&&e.hasCommittedMutations&&!e.hasLocalMutations}applyChanges(t,e,n,r){const s=this.Ra;this.Ra=t.Ra,this.mutatedKeys=t.mutatedKeys;const o=t.fa.G_();o.sort((u,d)=>function(p,y){const E=_=>{switch(_){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return $t()}};return E(p)-E(y)}(u.type,d.type)||this.Aa(u.doc,d.doc)),this.pa(n),r=r!=null&&r;const a=e&&!r?this.ya():[],c=this.da.size===0&&this.current&&!r?1:0,h=c!==this.Ea;return this.Ea=c,o.length!==0||h?{snapshot:new ps(this.query,t.Ra,s,o,t.mutatedKeys,c===0,h,!1,!!n&&n.resumeToken.approximateByteSize()>0),wa:a}:{wa:a}}Z_(t){return this.current&&t==="Offline"?(this.current=!1,this.applyChanges({Ra:this.Ra,fa:new wf,mutatedKeys:this.mutatedKeys,ns:!1},!1)):{wa:[]}}Sa(t){return!this.Ta.has(t)&&!!this.Ra.has(t)&&!this.Ra.get(t).hasLocalMutations}pa(t){t&&(t.addedDocuments.forEach(e=>this.Ta=this.Ta.add(e)),t.modifiedDocuments.forEach(e=>{}),t.removedDocuments.forEach(e=>this.Ta=this.Ta.delete(e)),this.current=t.current)}ya(){if(!this.current)return[];const t=this.da;this.da=ce(),this.Ra.forEach(n=>{this.Sa(n.key)&&(this.da=this.da.add(n.key))});const e=[];return t.forEach(n=>{this.da.has(n)||e.push(new km(n))}),this.da.forEach(n=>{t.has(n)||e.push(new Bm(n))}),e}ba(t){this.Ta=t.Ts,this.da=ce();const e=this.ma(t.documents);return this.applyChanges(e,!0)}Da(){return ps.fromInitialDocuments(this.query,this.Ra,this.mutatedKeys,this.Ea===0,this.hasCachedResults)}}class dw{constructor(t,e,n){this.query=t,this.targetId=e,this.view=n}}class fw{constructor(t){this.key=t,this.va=!1}}class pw{constructor(t,e,n,r,s,o){this.localStore=t,this.remoteStore=e,this.eventManager=n,this.sharedClientState=r,this.currentUser=s,this.maxConcurrentLimboResolutions=o,this.Ca={},this.Fa=new Ts(a=>om(a),Ka),this.Ma=new Map,this.xa=new Set,this.Oa=new Pe(Bt.comparator),this.Na=new Map,this.La=new ah,this.Ba={},this.ka=new Map,this.qa=fs.kn(),this.onlineState="Unknown",this.Qa=void 0}get isPrimaryClient(){return this.Qa===!0}}async function mw(i,t,e=!0){const n=Xm(i);let r;const s=n.Fa.get(t);return s?(n.sharedClientState.addLocalQueryTarget(s.targetId),r=s.view.Da()):r=await Hm(n,t,e,!0),r}async function gw(i,t){const e=Xm(i);await Hm(e,t,!0,!1)}async function Hm(i,t,e,n){const r=await Ub(i.localStore,Kn(t)),s=r.targetId,o=i.sharedClientState.addLocalQueryTarget(s,e);let a;return n&&(a=await _w(i,t,s,o==="current",r.resumeToken)),i.isPrimaryClient&&e&&Lm(i.remoteStore,r),a}async function _w(i,t,e,n,r){i.Ka=(d,f,p)=>async function(E,_,m,C){let b=_.view.ma(m);b.ns&&(b=await Sf(E.localStore,_.query,!1).then(({documents:T})=>_.view.ma(T,b)));const w=C&&C.targetChanges.get(_.targetId),N=C&&C.targetMismatches.get(_.targetId)!=null,U=_.view.applyChanges(b,E.isPrimaryClient,w,N);return If(E,_.targetId,U.wa),U.snapshot}(i,d,f,p);const s=await Sf(i.localStore,t,!0),o=new uw(t,s.Ts),a=o.ma(s.documents),c=yo.createSynthesizedTargetChangeForCurrentChange(e,n&&i.onlineState!=="Offline",r),h=o.applyChanges(a,i.isPrimaryClient,c);If(i,e,h.wa);const u=new dw(t,e,o);return i.Fa.set(t,u),i.Ma.has(e)?i.Ma.get(e).push(t):i.Ma.set(e,[t]),h.snapshot}async function vw(i,t,e){const n=Jt(i),r=n.Fa.get(t),s=n.Ma.get(r.targetId);if(s.length>1)return n.Ma.set(r.targetId,s.filter(o=>!Ka(o,t))),void n.Fa.delete(t);n.isPrimaryClient?(n.sharedClientState.removeLocalQueryTarget(r.targetId),n.sharedClientState.isActiveQueryTarget(r.targetId)||await Dl(n.localStore,r.targetId,!1).then(()=>{n.sharedClientState.clearQueryState(r.targetId),e&&hh(n.remoteStore,r.targetId),Nl(n,r.targetId)}).catch(go)):(Nl(n,r.targetId),await Dl(n.localStore,r.targetId,!0))}async function yw(i,t){const e=Jt(i),n=e.Fa.get(t),r=e.Ma.get(n.targetId);e.isPrimaryClient&&r.length===1&&(e.sharedClientState.removeLocalQueryTarget(n.targetId),hh(e.remoteStore,n.targetId))}async function Ew(i,t,e){const n=Aw(i);try{const r=await function(o,a){const c=Jt(o),h=He.now(),u=a.reduce((p,y)=>p.add(y.key),ce());let d,f;return c.persistence.runTransaction("Locally write mutations","readwrite",p=>{let y=gi(),E=ce();return c.cs.getEntries(p,u).next(_=>{y=_,y.forEach((m,C)=>{C.isValidDocument()||(E=E.add(m))})}).next(()=>c.localDocuments.getOverlayedDocuments(p,y)).next(_=>{d=_;const m=[];for(const C of a){const b=BM(C,d.get(C.key).overlayedDocument);b!=null&&m.push(new _r(C.key,b,Qp(b.value.mapValue),hi.exists(!0)))}return c.mutationQueue.addMutationBatch(p,h,m,a)}).next(_=>{f=_;const m=_.applyToLocalDocumentSet(d,E);return c.documentOverlayCache.saveOverlays(p,_.batchId,m)})}).then(()=>({batchId:f.batchId,changes:lm(d)}))}(n.localStore,t);n.sharedClientState.addPendingMutation(r.batchId),function(o,a,c){let h=o.Ba[o.currentUser.toKey()];h||(h=new Pe(fe)),h=h.insert(a,c),o.Ba[o.currentUser.toKey()]=h}(n,r.batchId,e),await xo(n,r.changes),await ic(n.remoteStore)}catch(r){const s=mh(r,"Failed to persist write");e.reject(s)}}async function zm(i,t){const e=Jt(i);try{const n=await Db(e.localStore,t);t.targetChanges.forEach((r,s)=>{const o=e.Na.get(s);o&&(ge(r.addedDocuments.size+r.modifiedDocuments.size+r.removedDocuments.size<=1),r.addedDocuments.size>0?o.va=!0:r.modifiedDocuments.size>0?ge(o.va):r.removedDocuments.size>0&&(ge(o.va),o.va=!1))}),await xo(e,n,t)}catch(n){await go(n)}}function Cf(i,t,e){const n=Jt(i);if(n.isPrimaryClient&&e===0||!n.isPrimaryClient&&e===1){const r=[];n.Fa.forEach((s,o)=>{const a=o.view.Z_(t);a.snapshot&&r.push(a.snapshot)}),function(o,a){const c=Jt(o);c.onlineState=a;let h=!1;c.queries.forEach((u,d)=>{for(const f of d.j_)f.Z_(a)&&(h=!0)}),h&&gh(c)}(n.eventManager,t),r.length&&n.Ca.d_(r),n.onlineState=t,n.isPrimaryClient&&n.sharedClientState.setOnlineState(t)}}async function xw(i,t,e){const n=Jt(i);n.sharedClientState.updateQueryState(t,"rejected",e);const r=n.Na.get(t),s=r&&r.key;if(s){let o=new Pe(Bt.comparator);o=o.insert(s,un.newNoDocument(s,Zt.min()));const a=ce().add(s),c=new tc(Zt.min(),new Map,new Pe(fe),o,a);await zm(n,c),n.Oa=n.Oa.remove(s),n.Na.delete(t),_h(n)}else await Dl(n.localStore,t,!1).then(()=>Nl(n,t,e)).catch(go)}async function Sw(i,t){const e=Jt(i),n=t.batch.batchId;try{const r=await Pb(e.localStore,t);Wm(e,n,null),Gm(e,n),e.sharedClientState.updateMutationState(n,"acknowledged"),await xo(e,r)}catch(r){await go(r)}}async function Tw(i,t,e){const n=Jt(i);try{const r=await function(o,a){const c=Jt(o);return c.persistence.runTransaction("Reject batch","readwrite-primary",h=>{let u;return c.mutationQueue.lookupMutationBatch(h,a).next(d=>(ge(d!==null),u=d.keys(),c.mutationQueue.removeMutationBatch(h,d))).next(()=>c.mutationQueue.performConsistencyCheck(h)).next(()=>c.documentOverlayCache.removeOverlaysForBatchId(h,u,a)).next(()=>c.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(h,u)).next(()=>c.localDocuments.getDocuments(h,u))})}(n.localStore,t);Wm(n,t,e),Gm(n,t),n.sharedClientState.updateMutationState(t,"rejected",e),await xo(n,r)}catch(r){await go(r)}}function Gm(i,t){(i.ka.get(t)||[]).forEach(e=>{e.resolve()}),i.ka.delete(t)}function Wm(i,t,e){const n=Jt(i);let r=n.Ba[n.currentUser.toKey()];if(r){const s=r.get(t);s&&(e?s.reject(e):s.resolve(),r=r.remove(t)),n.Ba[n.currentUser.toKey()]=r}}function Nl(i,t,e=null){i.sharedClientState.removeLocalQueryTarget(t);for(const n of i.Ma.get(t))i.Fa.delete(n),e&&i.Ca.$a(n,e);i.Ma.delete(t),i.isPrimaryClient&&i.La.gr(t).forEach(n=>{i.La.containsKey(n)||qm(i,n)})}function qm(i,t){i.xa.delete(t.path.canonicalString());const e=i.Oa.get(t);e!==null&&(hh(i.remoteStore,e),i.Oa=i.Oa.remove(t),i.Na.delete(e),_h(i))}function If(i,t,e){for(const n of e)n instanceof Bm?(i.La.addReference(n.key,t),Mw(i,n)):n instanceof km?(At("SyncEngine","Document no longer in limbo: "+n.key),i.La.removeReference(n.key,t),i.La.containsKey(n.key)||qm(i,n.key)):$t()}function Mw(i,t){const e=t.key,n=e.path.canonicalString();i.Oa.get(e)||i.xa.has(n)||(At("SyncEngine","New document in limbo: "+e),i.xa.add(n),_h(i))}function _h(i){for(;i.xa.size>0&&i.Oa.size<i.maxConcurrentLimboResolutions;){const t=i.xa.values().next().value;i.xa.delete(t);const e=new Bt(we.fromString(t)),n=i.qa.next();i.Na.set(n,new fw(e)),i.Oa=i.Oa.insert(e,n),Lm(i.remoteStore,new Pi(Kn(rm(e.path)),n,"TargetPurposeLimboResolution",Ql.oe))}}async function xo(i,t,e){const n=Jt(i),r=[],s=[],o=[];n.Fa.isEmpty()||(n.Fa.forEach((a,c)=>{o.push(n.Ka(c,t,e).then(h=>{var u;if((h||e)&&n.isPrimaryClient){const d=h?!h.fromCache:(u=e==null?void 0:e.targetChanges.get(c.targetId))===null||u===void 0?void 0:u.current;n.sharedClientState.updateQueryState(c.targetId,d?"current":"not-current")}if(h){r.push(h);const d=lh.Wi(c.targetId,h);s.push(d)}}))}),await Promise.all(o),n.Ca.d_(r),await async function(c,h){const u=Jt(c);try{await u.persistence.runTransaction("notifyLocalViewChanges","readwrite",d=>ot.forEach(h,f=>ot.forEach(f.$i,p=>u.persistence.referenceDelegate.addReference(d,f.targetId,p)).next(()=>ot.forEach(f.Ui,p=>u.persistence.referenceDelegate.removeReference(d,f.targetId,p)))))}catch(d){if(!_o(d))throw d;At("LocalStore","Failed to update sequence numbers: "+d)}for(const d of h){const f=d.targetId;if(!d.fromCache){const p=u.os.get(f),y=p.snapshotVersion,E=p.withLastLimboFreeSnapshotVersion(y);u.os=u.os.insert(f,E)}}}(n.localStore,s))}async function bw(i,t){const e=Jt(i);if(!e.currentUser.isEqual(t)){At("SyncEngine","User change. New user:",t.toKey());const n=await Cm(e.localStore,t);e.currentUser=t,function(s,o){s.ka.forEach(a=>{a.forEach(c=>{c.reject(new Tt(nt.CANCELLED,o))})}),s.ka.clear()}(e,"'waitForPendingWrites' promise is rejected due to a user change."),e.sharedClientState.handleUserChange(t,n.removedBatchIds,n.addedBatchIds),await xo(e,n.hs)}}function ww(i,t){const e=Jt(i),n=e.Na.get(t);if(n&&n.va)return ce().add(n.key);{let r=ce();const s=e.Ma.get(t);if(!s)return r;for(const o of s){const a=e.Fa.get(o);r=r.unionWith(a.view.Va)}return r}}function Xm(i){const t=Jt(i);return t.remoteStore.remoteSyncer.applyRemoteEvent=zm.bind(null,t),t.remoteStore.remoteSyncer.getRemoteKeysForTarget=ww.bind(null,t),t.remoteStore.remoteSyncer.rejectListen=xw.bind(null,t),t.Ca.d_=cw.bind(null,t.eventManager),t.Ca.$a=lw.bind(null,t.eventManager),t}function Aw(i){const t=Jt(i);return t.remoteStore.remoteSyncer.applySuccessfulWrite=Sw.bind(null,t),t.remoteStore.remoteSyncer.rejectFailedWrite=Tw.bind(null,t),t}class ka{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(t){this.serializer=ec(t.databaseInfo.databaseId),this.sharedClientState=this.Wa(t),this.persistence=this.Ga(t),await this.persistence.start(),this.localStore=this.za(t),this.gcScheduler=this.ja(t,this.localStore),this.indexBackfillerScheduler=this.Ha(t,this.localStore)}ja(t,e){return null}Ha(t,e){return null}za(t){return Ib(this.persistence,new Rb,t.initialUser,this.serializer)}Ga(t){return new bb(ch.Zr,this.serializer)}Wa(t){return new Fb}async terminate(){var t,e;(t=this.gcScheduler)===null||t===void 0||t.stop(),(e=this.indexBackfillerScheduler)===null||e===void 0||e.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}ka.provider={build:()=>new ka};class Ul{async initialize(t,e){this.localStore||(this.localStore=t.localStore,this.sharedClientState=t.sharedClientState,this.datastore=this.createDatastore(e),this.remoteStore=this.createRemoteStore(e),this.eventManager=this.createEventManager(e),this.syncEngine=this.createSyncEngine(e,!t.synchronizeTabs),this.sharedClientState.onlineStateHandler=n=>Cf(this.syncEngine,n,1),this.remoteStore.remoteSyncer.handleCredentialChange=bw.bind(null,this.syncEngine),await iw(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(t){return function(){return new sw}()}createDatastore(t){const e=ec(t.databaseInfo.databaseId),n=function(s){return new Hb(s)}(t.databaseInfo);return function(s,o,a,c){return new Wb(s,o,a,c)}(t.authCredentials,t.appCheckCredentials,n,e)}createRemoteStore(t){return function(n,r,s,o,a){return new Xb(n,r,s,o,a)}(this.localStore,this.datastore,t.asyncQueue,e=>Cf(this.syncEngine,e,0),function(){return Mf.D()?new Mf:new Vb}())}createSyncEngine(t,e){return function(r,s,o,a,c,h,u){const d=new pw(r,s,o,a,c,h);return u&&(d.Qa=!0),d}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,t.initialUser,t.maxConcurrentLimboResolutions,e)}async terminate(){var t,e;await async function(r){const s=Jt(r);At("RemoteStore","RemoteStore shutting down."),s.L_.add(5),await Eo(s),s.k_.shutdown(),s.q_.set("Unknown")}(this.remoteStore),(t=this.datastore)===null||t===void 0||t.terminate(),(e=this.eventManager)===null||e===void 0||e.terminate()}}Ul.provider={build:()=>new Ul};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rw{constructor(t){this.observer=t,this.muted=!1}next(t){this.muted||this.observer.next&&this.Ya(this.observer.next,t)}error(t){this.muted||(this.observer.error?this.Ya(this.observer.error,t):mi("Uncaught Error in snapshot listener:",t.toString()))}Za(){this.muted=!0}Ya(t,e){setTimeout(()=>{this.muted||t(e)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gi{constructor(t,e,n){this.converter=e,this._query=n,this.type="query",this.firestore=t}withConverter(t){return new Gi(this.firestore,t,this._query)}}class On{constructor(t,e,n){this.converter=e,this._key=n,this.type="document",this.firestore=t}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Bi(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new On(this.firestore,t,this._key)}}class Bi extends Gi{constructor(t,e,n){super(t,e,rm(n)),this._path=n,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new On(this.firestore,null,new Bt(t))}withConverter(t){return new Bi(this.firestore,t,this._path)}}function Of(i,t,...e){if(i=cs(i),$m("collection","path",t),i instanceof sc){const n=we.fromString(t,...e);return Nf(n),new Bi(i,null,n)}{if(!(i instanceof On||i instanceof Bi))throw new Tt(nt.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const n=i._path.child(we.fromString(t,...e));return Nf(n),new Bi(i.firestore,null,n)}}function Ow(i,t,...e){if(i=cs(i),arguments.length===1&&(t=Yp.newId()),$m("doc","path",t),i instanceof sc){const n=we.fromString(t,...e);return Lf(n),new On(i,null,new Bt(n))}{if(!(i instanceof On||i instanceof Bi))throw new Tt(nt.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const n=i._path.child(we.fromString(t,...e));return Lf(n),new On(i.firestore,i instanceof Bi?i.converter:null,new Bt(n))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`+o.stack),a}(n);throw mi("INTERNAL UNHANDLED ERROR: ",r),n}).then(n=>(this.du=!1,n))));return this.mu=e,e}enqueueAfterDelay(t,e,n){this.fu(),this.Ru.indexOf(t)>-1&&(e=0);const r=ph.createAndSchedule(this,t,e,n,s=>this.yu(s));return this.Tu.push(r),r}fu(){this.Eu&&$t()}verifyOperationInProgress(){}async wu(){let t;do t=this.mu,await t;while(t!==this.mu)}Su(t){for(const e of this.Tu)if(e.timerId===t)return!0;return!1}bu(t){return this.wu().then(()=>{this.Tu.sort((e,n)=>e.targetTimeMs-n.targetTimeMs);for(const e of this.Tu)if(e.skipDelay(),t!=="all"&&e.timerId===t)break;return this.wu()})}Du(t){this.Ru.push(t)}yu(t){const e=this.Tu.indexOf(t);this.Tu.splice(e,1)}}class vh extends sc{constructor(t,e,n,r){super(t,e,n,r),this.type="firestore",this._queue=new Ff,this._persistenceKey=(r==null?void 0:r.name)||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const t=this._firestoreClient.terminate();this._queue=new Ff(t),this._firestoreClient=void 0,await t}}}function Fw(i,t){const e=typeof i=="object"?i:OT(),n=typeof i=="string"?i:"(default)",r=DT(e,"firestore").getImmediate({identifier:n});if(!r._initialized){const s=bS("firestore");s&&Uw(r,...s)}return r}function Km(i){if(i._terminated)throw new Tt(nt.FAILED_PRECONDITION,"The client has already been terminated.");return i._firestoreClient||Vw(i),i._firestoreClient}function Vw(i){var t,e,n;const r=i._freezeSettings(),s=function(a,c,h,u){return new uM(a,c,h,u.host,u.ssl,u.experimentalForceLongPolling,u.experimentalAutoDetectLongPolling,Ym(u.experimentalLongPollingOptions),u.useFetchStreams)}(i._databaseId,((t=i._app)===null||t===void 0?void 0:t.options.appId)||"",i._persistenceKey,r);i._componentsProvider||!((e=r.localCache)===null||e===void 0)&&e._offlineComponentProvider&&(!((n=r.localCache)===null||n===void 0)&&n._onlineComponentProvider)&&(i._componentsProvider={_offline:r.localCache._offlineComponentProvider,_online:r.localCache._onlineComponentProvider}),i._firestoreClient=new Cw(i._authCredentials,i._appCheckCredentials,i._queue,s,i._componentsProvider&&function(a){const c=a==null?void 0:a._online.build();return{_offline:a==null?void 0:a._offline.build(c),_online:c}}(i._componentsProvider))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Jw(i,t,e){let n;return n=i?i.toFirestore(t):t,n}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
